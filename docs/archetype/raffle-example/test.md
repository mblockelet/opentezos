...
In this tutorial example, the chest time paramater imposed by the contract is `10000000`.

::: info
Note that it's *not* a decent value since it takes 20s to break on a recent computer ...
:::
