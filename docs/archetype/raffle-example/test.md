...
The raffle key used in this test is the integer `123456`. The value is first packed (turned into bytes) before being timlocked with the raffle duration of 1 hour.

The following snippet enables to pack the value:
```js
const raffle_key = 123456
...
The corresponding chest key value:
